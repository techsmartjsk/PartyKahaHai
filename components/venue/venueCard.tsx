  ...
  return (
    <View style={styles.card}>
      <View className='relative'>
        <Image source={require('../../assets/images/venueImage.png')} style={styles.image} />
      ...
      <View className='px-4 py-2'>
        <View className='flex flex-row justify-between'>
            <Text style={styles.title} className='font-ubuntuBold'>The Boozy Griffin</Text>
            <View className='rounded-lg bg-[#13B837] px-2 py-2 h-[30px] flex'>
                <Text className='text-white font-ubuntuBold'>4.2/5</Text>
            </View>
        </View>
        <Text style={styles.description} className='font-ubuntu'>Continental • Italian • North Indian</Text>
        ...
        <View className='flex flex-row space-x-2 items-center'>
            ...
            <Text className='text-[#AD00DF] my-4'>
