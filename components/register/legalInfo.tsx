    ...
    >
      ...
      <ScrollView className="h-full rounded-t-2xl bg-white">
        <View className="bg-[#730194] pb-5 mx-20 rounded-b-3xl flex py-5 items-center justify-center">
          <Text className="text-center text-white font-bold font-ubuntu">
        ...
        <View className="px-5 flex flex-col gap-y-4 py-5">
          <View className="flex flex-row justify-center gap-x-4">
            <View className="flex flex-col gap-y-2">
              <View className="w-[100px] h-[3px] bg-[#828282] rounded-lg"></View>
            ...
            <View className="flex flex-col gap-y-2">
              ...
              <View className="flex flex-row gap-x-1 items-center">
                <RadioButton.IOS
                  ...
                  status="checked"
                />
                <Text className="font-bold text-md text-[#828282]">
                  Personal Info
                </Text>
              </View>
            </View>
            <View className="flex flex-col gap-y-2">
              ...
              <View className="flex flex-row gap-x-1 items-center">
                <RadioButton.Android
                  ...
                  status="checked"
                />
                <Text className="font-bold text-md text-[#697386] font-ubuntu">
                  About you
                </Text>
              </View>
            </View>
