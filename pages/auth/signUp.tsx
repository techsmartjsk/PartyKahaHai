  ...
  return (
    ...
    >
      ...
      <View className="rounded-t-2xl shadow-lg pt-10 bg-white mt-[220px]">
        ...
        <Text className="text-[#828282] text-md my-5 mx-5 font-ubuntu">
          Designed to bring people together—sign up and start connecting with
          people locally, right where you are.
        </Text>
      </View>
      ...
      <View className="bg-white h-full">
        <View className="flex flex-row gap-x-2 justify-center items-center mt-12 ">
          <Text className="text-[12px] text-center font-ubuntu">
            Already have an account?
          </Text>
          <Text
            onPress={handleSignIn}
            className="text-[16px] text-center text-[#AD00DF] font-ubuntu underline font-bold"
          >
            Sign in
          </Text>
        </View>
